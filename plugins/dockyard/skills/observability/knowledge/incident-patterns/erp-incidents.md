...
- Cascade detection: see BlobGC Cascade pattern above and [triage-signals.md](../triage-signals.md) cascade rules
- ERP error codes: [platform-extended.md](../platform-extended.md) ERP codes section
