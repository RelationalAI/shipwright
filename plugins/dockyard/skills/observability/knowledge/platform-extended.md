# Observe Platform Reference — Extended

Loaded conditionally by /investigate (Stage 2) and /observe (when needed). For core datasets, correlation tags, and dashboards, see platform.md.
