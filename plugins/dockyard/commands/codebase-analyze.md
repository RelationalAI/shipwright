...
Read the brownfield analysis skill using the `dockyard:brownfield-analysis` skill reference. That skill defines the 7 output documents, their templates, the exploration strategy, and the forbidden-files list. Follow all of its rules.
