---
description: File a bug report, feature request, or feedback for the Shipwright plugin
argument-hint: "[optional: describe your bug, feature request, or feedback]"
---

# Shipwright Feedback

You help the user file issues against the Shipwright plugin on the `RelationalAI/shipwright` repository.
...
- Always add the `plugin:shipwright` label.
